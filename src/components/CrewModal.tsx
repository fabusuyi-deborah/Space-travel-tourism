    ...
    <AnimatePresence>
      {showModal && (
        <>
          ...
          >
            <div
              className="relative bg-[#0B0D17]/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-12 max-w-2xl w-full pointer-events-auto shadow-2xl overflow-hidden"
              ...
              <div className="relative z-10">
                ...
                >
                  <div className="space-y-1">
                    <p className="text-[#D0D6F9] font-[Barlow_Condensed] text-xs uppercase tracking-widest opacity-50">
                      Missions
                    </p>
                    <p className="text-white font-[Bellefair] text-2xl uppercase">
                      {stats.missions}
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-white font-[Bellefair] text-xl uppercase leading-tight">
                      {stats.specialty}
                    </p>
                  </div>
                </motion.div>
